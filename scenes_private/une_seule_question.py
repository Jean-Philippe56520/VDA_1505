...
« Les plus belles œuvres ne sont pas faites d’encre. »
...
*Son regard retourne au coffret.*

« Mais ne détruis pas non plus le chemin avant de savoir où il conduit. »
...
« Et ne me condamne pas assez vite pour pouvoir partir avec la conscience propre. »

« Reste assez près pour voir ce que je fais. »
...
def get_scene() -> Scene:
    return Scene(
        ...
        choices=[
            Choice(
                id="une_question_ceux_qui_nous_ont_precedees",
                label="CEUX QUI NOUS ONT PRÉCÉDÉES — Que dois-je savoir de notre lignée ?",
                answer_md=REPONSES["ceux_qui_nous_ont_precedees"],
                ends_scene=True,
            ),
            Choice(
                id="une_question_chute_des_toreador",
                label="LA CHUTE DES TOREADOR — Pourquoi le clan Toreador est-il réellement tombé en 1493 ?",
                answer_md=REPONSES["chute_des_toreador"],
                ends_scene=True,
            ),
            Choice(
                id="une_question_zvonimir",
                label="ZVONIMIR — Qu’a réellement été Zvonimir pour toi ?",
                answer_md=REPONSES["zvonimir"],
                ends_scene=True,
            ),
            Choice(
                id="une_question_mes_fautes",
                label="MES FAUTES — Quelle est la faute que tu regrettes le plus ?",
                answer_md=REPONSES["mes_fautes"],
                ends_scene=True,
            ),
            Choice(
                id="une_question_notre_avenir",
                label="NOTRE AVENIR — Que veux-tu accomplir ?",
                answer_md=REPONSES["notre_avenir"],
                ends_scene=True,
            ),
        ],
        allow_undo=False,
